...
#define GIC_V2_DISTRIBUTOR_PPTR     0xFFF02000
#define GIC_V2_CONTROLLER_PPTR      0xFFF03000
...
#define GIC_V2_DISTRIBUTOR_PADDR    GIC_PADDR + 0x1000
#define GIC_V2_CONTROLLER_PADDR     GIC_PADDR + 0x2000
